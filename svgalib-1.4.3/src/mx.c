...
#define MX_TOTAL_REGS (VGA_TOTAL_REGS + 23)
...
void __svgalib_mxaccel_init(AccelSpecs * accelspecs, int bpp, int width_in_pixels);
...
moderegs[2]=p&0xff;
/*
moderegs[MXREG_SAVE(1)]&=0xfd;
moderegs[MXREG_SAVE(1)]|=(p&0x100)>>7;
*/
...
/*
moderegs[MXREG_SAVE(2)]&=0xfb;
moderegs[MXREG_SAVE(2)]|=(p&0x400)>>7;
*/
...
{
if (op==LINEAR_ENABLE || op==LINEAR_DISABLE){ mx_is_linear=1-mx_is_linear; return 0;}
